...
class PostAdmin(admin.ModelAdmin):
    ...
    search_fields = ("title", "content", "description", "keywords")
    prepopulated_fields = {"slug": ("title",)}
    list_filter = (
        "status",
        "category",
...
class CommentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("General Information", {"fields": ("user", "post", "parent", "content")}),
...
class PostLikeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("General Information", {"fields": ("user", "post")}),
...
class PostShareAdmin(admin.ModelAdmin):
    ...
    list_select_related = ("user", "post")
    fieldsets = (
        ("General Information", {"fields": ("user", "post", "platform")}),
        ("Timestamp", {"fields": ("timestamp",)}),
    )
...
class PostViewAdmin(admin.ModelAdmin):
    ...
    list_select_related = ("user", "post")
    fieldsets = (
        ("General Information", {"fields": ("user", "post", "ip_address")}),
        ("Timestamp", {"fields": ("timestamp",)}),
    )
